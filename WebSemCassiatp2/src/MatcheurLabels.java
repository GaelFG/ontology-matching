...
**/
public class MatcheurLabels extends URIAlignment{
    ...
    public double match(OWLEntity o1, OWLEntity o2) {
    	...
    	for (OWLLiteral lit1 : labels1) {
    		for (OWLLiteral lit2 : labels2) {
    			...
    			if(computeLevenshteinDistance(lit1.getLiteral().toLowerCase(), lit2.getLiteral().toLowerCase()) == 0.0);
    				return 1.0;
    		}
    	}
    	return 0.;
